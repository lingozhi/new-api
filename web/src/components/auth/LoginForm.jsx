...
const LoginForm = () => {
  ...
  const renderTermsCheckbox = () => (
    (hasUserAgreement || hasPrivacyPolicy) && (
      <div className='playful-auth-terms'>
        <Checkbox
          checked={agreedToTerms}
          onChange={(e) => setAgreedToTerms(e.target.checked)}
        >
          <Text size='small' className='!text-playful-muted-fg'>
            {t('我已阅读并同意')}
            {hasUserAgreement && (
              <a
                href='/user-agreement'
  ...
  const renderRegisterFooter = () => (
    !status.self_use_mode_enabled && (
      <div className='playful-auth-footer'>
        <Text>
          {t('没有账户？')}{' '}
          <Link to='/register' className='playful-link'>
            {t('注册')}
          </Link>
        </Text>
      </div>
      ...
      <Card className='playful-auth-card sticker-card bg-white'>
        ...
        <div className='space-y-3'>
          ...
          {status.passkey_login && passkeySupported && (
            ...
            >
              <span className='ml-2'>{t('使用 Passkey 登录')}</span>
            </StickerButton>
          )}

          <SquiggleDivider color='accent' label={t('或')} />
          ...
          >
            <span className='ml-2'>{t('使用 邮箱或用户名 登录')}</span>
          </StickerButton>
        </div>
  ...
  const renderEmailLoginForm = () => {
    return (
      <Card className='playful-auth-card sticker-card bg-white'>
        ...
        <Form className='playful-auth-form space-y-3'>
          <PlayfulFormField
            field='username'
            label={t('用户名或邮箱')}
  ...
  const renderWeChatLoginModal = () => {
    return (
      ...
      >
        ...
        <div className='text-center mb-4 text-playful-muted-fg'>
          <p>
