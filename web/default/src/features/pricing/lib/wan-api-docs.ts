...
export function buildWanAiIntegrationGuide(
  ...
  return [
    ...
    modelName === 'wan3.0-video-prime'
      ? '- Prime has independent pricing: 480P/720P/1080P multipliers are 0.5/1/2 relative to its configured 720P base price. At the configured discounted USD 0.63 base and group multiplier 1, rates are USD 0.315/0.63/1.26 per second: 2-second 480P costs USD 0.63; automatic 480P reserves USD 9.45; default 5-second 1080P reserves USD 6.30. The 0.7 discount is already included in the base price; do not apply it again. Check the actual website model and group prices before use.'
