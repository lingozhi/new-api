...
export function buildIndexTTSAudioSpeechParameters(
  ...
  return [
    ...
    },
    {
      ...
      descriptionKey:
        'Emotion control mode; choose the speaker reference, emotion reference audio, or emotion values',
    },
    {
      name: 'emo_disgusted',
      type: 'number',
...
export function buildIndexTTSAudioSpeechAiIntegrationGuide(
  ...
  return [
    ...
    '',
    '## Emotion controls',
    '- emo_control_method accepts 与音色参考音频相同, 使用情感参考音频, or 使用情感向量控制.',
    ...
    '- emo_surprised currently accepts only 0. emo_random accepts a boolean and defaults to false.',
