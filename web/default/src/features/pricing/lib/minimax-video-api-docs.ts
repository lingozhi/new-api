...
export function buildMiniMaxVideoParameters(
  ...
  return [
    ...
    },
    {
      ...
      defaultValue: false,
      descriptionKey:
        'Enable audio-synchronized animation for exactly one reference image and one reference audio item',
    },
    {
      name: 'callback_url',
      type: 'string',
...
export function buildMiniMaxVideoAiIntegrationGuide(
  ...
  return [
    ...
    '- content contains 1 to 16 items and must include at least one non-empty text item.',
